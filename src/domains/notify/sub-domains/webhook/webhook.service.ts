 ...
 * - **Notes:** organization scoping is enforced via `withAppDatabaseContext` (token-minted scope).
 */
 ...
 *
 * @remarks
 * - **Algorithm:** every read/write runs inside `withAppDatabaseContext` with the
