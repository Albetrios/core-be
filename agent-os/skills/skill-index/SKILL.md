...
| rls-tenant-isolation-guard | `agent-os/skills/rls-tenant-isolation-guard/SKILL.md` | Postgres RLS + tenant isolation (FORCE RLS, organization GUC, worker context wrappers) |
| read-cache-guard | `agent-os/skills/read-cache-guard/SKILL.md` | Scope-keyed keys, tombstone-not-DEL, invalidate after commit, five tests |
...
| find-skills | `agent-os/skills/find-skills/SKILL.md` | user-invoked; discover/install skills — search the project catalog first, then the open ecosystem (no file trigger) |
...
| `structure-maintainer-sync.mdc`           | `AGENTS.md`, `CLAUDE.md`, `README.md`, `agent-os/rules/**`, `agent-os/skills/**`, `agent-os/agents/**`, `agent-os/mcp/**`, `.mcp.example.json`, `.mcp.default.json`                     | structure-maintainer                                                       |
