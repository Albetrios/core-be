...
- **Rules:** `agent-os/rules/be-src-architecture.mdc` — ensure it matches current layout and naming. `agent-os/rules/be-seed-conventions.mdc` (if the `seed/` dir layout or seed contract changed).
- **Skills:**
  - `agent-os/skills/be-domain-generator/SKILL.md` (scaffolding and sub-domain list)
  - `agent-os/skills/be-workers-events/SKILL.md` (if events/queues/workers paths changed)
  - `agent-os/skills/be-seed-maintainer/SKILL.md` (if the `seed/` dir layout, seed contract, or tiers changed)
  - `agent-os/skills/be-supabase-porting/SKILL.md` (if Supabase porting conventions changed)
  - `agent-os/skills/be-db-migration-maintainer/SKILL.md` (if SQL migration conventions changed)
  - `agent-os/skills/be-test-generator/SKILL.md` (if test layout or scripts changed)
  - `agent-os/skills/be-overview-doc-maintainer/SKILL.md` (if a new folder role appears that needs a new `<folder>.overview.md` template)
...
Enforced by `src/tests/global/import-paths.global.test.ts`. Rule: `agent-os/rules/be-import-paths.mdc`.
...
- Three tiers: `pnpm db:seed` (reference) · `pnpm db:seed:full` (demo) · `pnpm db:seed:bulk` (scaled). Detail: **be-seed-maintainer**, `agent-os/rules/be-seed-conventions.mdc`, `src/scripts/seed/seed.overview.md`.
...
- **Detail**: `agent-os/skills/be-test-generator/SKILL.md`, `agent-os/rules/be-testing-conventions.mdc`.
...
- `agent-os/skills/be-skill-index/SKILL.md` (master skill trigger map and enforcement layers — update when adding skills or changing pre-commit/CI checks)
...
- `agent-os/rules/be-src-architecture.mdc` (Cursor rule enforcement hints)
- `agent-os/skills/be-domain-generator/SKILL.md` (scaffolding conventions)
- `agent-os/skills/be-workers-events/SKILL.md` (events/queues/workers conventions)
- `agent-os/skills/be-supabase-porting/SKILL.md` (Supabase porting)
- `agent-os/skills/be-db-migration-maintainer/SKILL.md` (SQL migrations)
- `agent-os/skills/be-test-generator/SKILL.md` (testing pyramid and layout)
- `agent-os/skills/be-openapi-route-sync/SKILL.md` (OpenAPI route metadata)
- `agent-os/skills/be-cursor-global-skills/SKILL.md` (Cursor built-in skills reference)
- `agent-os/skills/be-route-catalog/SKILL.md` (route listing conventions)
- `agent-os/skills/be-code-quality-guard/SKILL.md` (ESLint, pre-commit, CI security pipeline)
- Any other `agent-os/skills/*/SKILL.md` that references paths or layer names
- **Docs**: When docs are reorganized or renamed, run **be-docs-maintainer** to update `docs/README.md` and cross-links (see `agent-os/skills/be-docs-maintainer/SKILL.md`).
...
4. **Update rule text**
   - Ensure `agent-os/rules/be-src-architecture.mdc` matches the current structure and naming.
