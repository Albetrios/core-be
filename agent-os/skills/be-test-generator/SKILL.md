...
Triggered by `be-testing-conventions.mdc` when test-related or pure-layer files change.
...
- [ ] New **permission** → align seeds (`be-seed-maintainer`) and test with/without permission
...
**Related skills:** [be-chaos-test-maintainer](../be-chaos-test-maintainer/SKILL.md) · [be-contract-test-maintainer](../be-contract-test-maintainer/SKILL.md)
